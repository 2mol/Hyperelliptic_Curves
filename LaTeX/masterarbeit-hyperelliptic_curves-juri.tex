...
%With our addition law will come a few interesting properties, namely the fact that the resulting group will automatically be abelian, which is a nice touch. But

There are a few caveats to our explicit approach.
%For one, the fickleness of distinguishing between six cases is certainly not desirable in the sense of mathematical elegance. But there is also the question of applicability.
...
\section{Rational Functions on Hyperelliptic Curves}
