...
\begin{lemma}\label{mult}
  ...
  \begin{proof} %The statement has already been proven true for $e, i, k \leq 4$ in each of the different cases.
    By construction we have in all non-zero cases% for $D(x) = C(x) - p^2(x)$
    \begin{align*}
...
\begin{proof}\textit{First part}
  ...
  \end{align*}
  As in Lemma \ref{mult}, $e_i$ denotes the exact number of occurrences of $\q_i$.%, i.e. exactly $e_i$ of the $\q_i$ equal to some $\q_k$.
